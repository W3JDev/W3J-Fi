...
*Source: [`log-lottery`](https://github.com/LOG1997/log-lottery/blob/main/src/store/personConfig.ts)*
...
- Winner announced  
*Source: [`random-name-picker`](https://github.com/icelam/random-name-picker/blob/master/src/assets/js/Slot.ts)*
...
*Source: [`OpenStreamPoll`](https://github.com/yoanbernabeu/OpenStreamPoll/blob/main/src/Controller/PollController.php)*
...
1. Pick up assigned GitHub issue
2. Review specifications
3. Integrate per requirements
4. Implement features per criteria
